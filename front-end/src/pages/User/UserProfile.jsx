            ...
            <div className="bg-slate-50">
                <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-8">
                    <div className="flex flex-col lg:flex-row gap-6 items-start">
                        <aside
                            className="w-full lg:w-[30%] bg-white border border-slate-100 shadow-sm rounded-3xl p-6 h-fit"
                        >
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="space-y-6 text-slate-700">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    className={`inline-flex items-center px-3 py-1 rounded-full text-sm border ${STATUS_META[selectedOrder.statusNormalized]
                                                        ?.badge || "border-slate-200 text-slate-600"
                                                        }`}
                                                >
                                                    {STATUS_META[selectedOrder.statusNormalized]?.label ||
                                            ...
                                            <div className="mt-6 flex justify-between items-center">
                                                ...
                                                <button
                                                    ...
                                                    className="bg-amber-600 text-white py-2 px-6 rounded-xl hover:bg-amber-500 transition"
                                                >
                                                    Đóng
                                                </button>
                                            </div>
